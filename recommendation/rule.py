...
def Association(userUID, clothe_type, season, top_uid1, top_uid2, top_uid3):

    db = firestore.client()

    doc_ref = db.collection(u'Transaction').document(userUID).collection(clothe_type).get()
    records = []
...
if __name__ == "__main__":
    ...
    bottom_match = Association(userUID, "bottom", season, top_uid1, top_uid2, top_uid3)
    outer_match = Association(userUID, "outer", season, top_uid1, top_uid2, top_uid3)
